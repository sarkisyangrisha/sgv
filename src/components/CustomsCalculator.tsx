...
const COUNTRIES: { [key: string]: CountryInfo } = {
  ...
  JP_SANCTIONED: { 
    ...
    sanctioned: true,
    shippingCosts: {
      amount: 0, // Will be calculated based on car price
      currency: 'USD'
    }
  },
  KR: { 
...
const getRecyclingFee = (engineVolume: number, age: 'new' | 'medium' | 'old', isPersonal: boolean = true): number => {
  // For engines > 3000cc, only commercial rates apply
  ...
  // For engines <= 3000cc, both personal and commercial rates are available
  if (isPersonal) {
    return age === 'new' ? 3400 : 5200;
  }

  // Commercial recycling fees for engines <= 3000cc
        ...
        {result && (
          <div className="mt-6 space-y-3 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-gray-600 p-2 rounded">
